...
namespace vga::modifier {
    ...
    //
    VGAStreamColorModifier::VGAStreamColorModifier(uint8_t color): VGAStreamModifier(), _color{color} {
    }
    ...
    //
    VGAStreamBackgroundModifier::VGAStreamBackgroundModifier(uint8_t bg_color): VGAStreamColorModifier(bg_color) {
    }

    VGAStreamBackgroundModifier::VGAStreamBackgroundModifier(color::t_vga_color bg_color): VGAStreamColorModifier(bg_color) {
    }
    ...
    //
    VGAStreamForegroundModifier::VGAStreamForegroundModifier(uint8_t foreground): VGAStreamColorModifier(foreground) {
    }

    VGAStreamForegroundModifier::VGAStreamForegroundModifier(color::vga_color foreground): VGAStreamColorModifier(foreground) {
    }
    ...
    // VGASetLineModifier
    //
    VGASetLineModifier::VGASetLineModifier(uint16_t line): VGAStreamCursorModifier(), _line{line} {
    }
